...
var SHEET_DEFS = [
  ...
  {
    name: SHEETS.CHECK,
    headers: ['check_id', '対象種別', '項目名', '判定ルールID', '確認先役割', '優先度', '質問文', '選択肢', '有効'],
...
var INITIAL_CHECKS = [
  ...
  ['CHK101', 'support', '在否確認', 'R02', '夜勤', 'A',
   '{対象}さんは{日付}、ホームにいましたか？', '在宅|外泊・帰省|入院|わからない', false],
  ['CHK102', 'support', '夜間巡回・就寝確認', 'R02', '夜勤', 'A',
   '{対象}さんの{日付}夜の巡回・就寝確認の記録がありません。', '実施した|未実施だった|わからない', false],
  ['CHK103', 'support', '支援内容', 'R02', '夜勤', 'A',
   '{対象}さんへの{日付}の支援内容の記録がありません。', '記録あり（一言記入）|特記なし|わからない', false],
  ['CHK104', 'support', '利用者の状況', 'R02', '夜勤', 'A',
   '{対象}さんの{日付}の様子はいかがでしたか？', '変わりなし|対応あり|わからない', false],
  ['CHK105', 'support', '食事提供', 'R02', '夜勤', 'A',
   '{対象}さんの{日付}の食事提供の記録がありません。', '提供した|提供なし|わからない', false],
  ['CHK106', 'support', '服薬確認', 'R02', '夜勤', 'A',
   '{対象}さんの{日付}の服薬確認の記録がありません。', '実施した（記録漏れ）|未実施だった|わからない', false],
  ['CHK107', 'support', '緊急時・異常時対応', '-', '夜勤', 'A',
   '※検出対象外。「報告」コマンドで随時受け付ける', '', false],

  // Phase2：優先度B（Aが安定してから有効化）
  ['CHK111', 'support', '入浴', 'R02', '夜勤', 'B',
   '{対象}さんの{日付}の入浴の記録がありません。', '実施した|未実施だった|わからない', false],
  ['CHK112', 'support', '外出・帰宅時間', 'R02', '夜勤', 'B',
   '{対象}さんの{日付}の外出・帰宅の記録がありません。', '外出なし|外出あり|わからない', false],
  ['CHK113', 'support', '日中活動', 'R02', '日勤', 'B',
   '{対象}さんの{日付}の日中活動の記録がありません。', '参加した|休んだ|わからない', false],
...
var NEEDS_NOTE_ANSWERS = [
  '未実施だった', '対応あり', '記録あり（一言記入）', '外出あり', '一部不要', '休んだ', '入院', '今答える'
];
